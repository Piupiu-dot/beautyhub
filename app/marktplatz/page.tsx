...
const DEMO = [
  {id:'1',titel:'IPL Geraet Lumenis M22',beschreibung:'Wenig benutzt, alle Handtuecher vorhanden. Serviciert 2024.',preis:4800,kategorie:'geraete',zustand:'gebraucht',standort:'Zuerich'},
  {id:'2',titel:'Nagelfraeeser Dremel Set',beschreibung:'Komplettes Set mit 12 Bits, kaum benutzt.',preis:120,kategorie:'geraete',zustand:'neu',standort:'Bern'},
  ...
  {id:'4',titel:'PMU Kurs Grundlagen',beschreibung:'2-taegiger Intensivkurs. Zertifikat wird ausgestellt.',preis:480,kategorie:'kurse',zustand:'neu',standort:'Zuerich'},
]
            ...
            {!chat ? (
              ...
              <div className="flex flex-col h-[70vh]">
                <div className="p-4 border-b border-[#F0EAE0] flex items-center gap-3 flex-shrink-0">
                  ...
                  <div><p className="text-sm font-semibold text-[#1A1A2E]">Verkaeuferin</p><p className="text-xs text-[#9A9A9A] truncate max-w-[180px]">{detail.titel}</p></div>
                </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div><label className="block text-[11px] font-medium text-[#6B6B6B] uppercase tracking-wider mb-1.5">Kategorie</label>
                  <select className={ic} value={form.kategorie} onChange={e=>setForm({...form,kategorie:e.target.value})}>
                    <option value="geraete">Geraete</option><option value="produkte">Produkte</option><option value="mobel">Moebel</option><option value="kurse">Kurse</option><option value="sonstiges">Sonstiges</option>
                  </select></div>
